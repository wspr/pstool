...
The current release of this package does not support cross-references within the \pkg{psfrag} labels of the included graphics.
(If, say, you wish to refer to an equation number or a citation within a figure.)

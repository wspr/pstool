...
Running `latex` on pstool.tex will produce pstool.sty. Executing
  `pdflatex "\let\compile=y\input pstool.tex"`
will produce the typeset documentation as well.

...
%
% v1.4a: Use \cs{filemodCmp} instead of \cs{pstool@IfnewerEPS} -- Heinrich Kruger
...
% Break out the separate function in order to expand \cs{pstool@tex} before writing it.
\newcommand\pstool@@@psfragfig[3]{%
  \pstool#2{\pstool@eps}{%
